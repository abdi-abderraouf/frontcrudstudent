...
class UpdateStudentInfo extends Component {
  ...
  componentDidMount() {
    ...
    axios
      .get('https://backendstudentscrud.onrender.com/students/'+this.props.match.params.id)
      .then(res => {
  ...
  onSubmit = e => {
    ...
    axios
      .put('https://backendstudentscrud.onrender.com/students/'+this.props.match.params.id, data)
      .then(res => {
